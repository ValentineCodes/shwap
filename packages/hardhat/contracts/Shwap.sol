...
contract Shwap {
    ...
    /**
     * @notice initializes amount of tokens that will be transferred to the Shwap itself from the erc20 contract mintee (and only them based on how FUN.sol is written). Loads contract up with both ETH and FUN.
    ...
    /**
     * @notice sends Ether to Shwap in exchange for $FUN
     */
    ...
    /**
     * @notice sends $FUN tokens to Shwap in exchange for Ether
     */
